...
The project has defined a [code of conduct](https://github.com/FantasticFiasco/mvvm-dialogs/blob/main/CODE_OF_CONDUCT.md), providing a welcoming and friendly environment. Please adhere to it in all interactions.
...
```sh
git clone https://github.com/<your username>/serilog-sinks-udp.git
```

Navigate into the cloned directory and create a new branch:

```sh
cd serilog-sinks-udp
...
[issues]: https://github.com/FantasticFiasco/serilog-sinks-udp/issues
[issues_new]: https://github.com/FantasticFiasco/serilog-sinks-udp/issues/new
[issues_bugs]: https://github.com/FantasticFiasco/serilog-sinks-udp/issues?q=label%3Abug
[discussions]: https://github.com/FantasticFiasco/serilog-sinks-udp/discussions
[discussions_new]: https://github.com/FantasticFiasco/serilog-sinks-udp/discussions/new
